    ...
    public partial class Form1 : Form
    {
        ...
        */
        private void addNew_Button_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            else
            {
                ...
                // Add the new recycler to the file.
                Recycler recycler = new Recycler(name, address, phone, website, recycles);
                rList.Add(recycler);
                rList.Sort();
        ...
        */
        private void update_Button_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            else
            {
                ...
                DialogResult dialogResult = MessageBox.Show("Do you wish to proceed in updating the record for " + originalFName + " ? ", "Update existing recycler record?", MessageBoxButtons.YesNo);

                // Yes selected.
                if (dialogResult == DialogResult.Yes)
                {
                    // Update existing Recycler object directly
                    ...
                    // Re-sort list after change
                    rList.Sort();

                    // Re-display updated list
                    DisplayRecyclersList();

                    // Update currentRecord index (since sort may change it)
        ...
        */
        private void delete_Button_Click(object sender, EventArgs e)
        {
            ...
            // Adjust currentRecord if it's now out of bounds
            if (currentRecord >= rList.Count)
            {
                currentRecord = rList.Count - 1;
            }
